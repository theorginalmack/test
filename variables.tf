...
variable "talos_image_file" {
  ...
  description = "Path to the Oracle image archive generated by build_oracle_image.py."
  type        = string
}

variable "talos_image_version" {
  default     = "1.12.6"
  description = "The Talos version used for the uploaded Oracle image object."
  type        = string
}

variable "talos_extensions" {
  default     = ["crun"]
  description = "Official Talos system extensions to include in the Talos image factory schematic."
  type        = list(string)
}
